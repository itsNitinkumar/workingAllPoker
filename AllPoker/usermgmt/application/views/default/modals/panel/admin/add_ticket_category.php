...
<!-- Add Tickets Category Modal: -->
<div class="modal close-after" id="add-tickets-category">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form class="z-form" action="<?php admin_action( 'support/add_category' ); ?>" method="post">
        <div class="modal-header">
          <h5 class="modal-title"><?php echo lang( 'add_tickets_category' ); ?></h5>
