...
<div class="modal close-after" id="add-custom-field">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form class="z-form" action="<?php admin_action( 'tools/add_custom_field' ); ?>" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-control select2 search-disabled" id="field-type-add" name="type">
                ...
                <option value="password"><?php echo lang( 'password' ); ?></option>
          ...
          <!-- /.form-group -->
          <div class="form-group">
            <label for="show-when-register-add"><?php echo lang( 'show_when_register' ); ?></label>
            <select class="form-control select2 search-disabled" id="show-when-register-add" name="on_registeration">
