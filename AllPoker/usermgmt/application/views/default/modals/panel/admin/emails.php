            ...
            <div class="col-md-6 cpt-1">
              <table class="table table-bordered text-nowrap text-sm table-sm">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <?php echo lang( 'sub_confirmation_link' ); ?>
                      <span class="float-right text-primary">{SUB_LINK}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      <?php echo lang( 'unsub_link' ); ?>
                      <span class="float-right text-primary">{UNSUB_LINK}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <?php echo lang( '2f_code' ); ?>
                      <span class="float-right text-primary">{2F_CODE}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      <?php echo lang( 'custom_subject' ); ?>
                      <span class="float-right text-primary">{SUBJECT}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <?php echo lang( 'custom_message' ); ?>
                      <span class="float-right text-primary">{MESSAGE}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
