            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                  ...
                  <!-- /.form-group -->
                  <label for="2f-auth"><?php echo lang( '2f_authentication' ); ?></label>
                  <select id="2f-auth" class="form-control select2 search-disabled" name="u_2f_authentication">
                    <option value="0" <?php echo select_single( 0, db_config( 'u_2f_authentication' ) ); ?>><?php echo lang( 'disable' ); ?></option>
                    <option value="1" <?php echo select_single( 1, db_config( 'u_2f_authentication' ) ); ?>><?php echo lang( 'email' ); ?></option>
                  </select>
                </div>
                <!-- /.tab-pane -->
                ...
                <div class="tab-pane" id="register" role="tabpanel" aria-labelledby="register-tab">
                  ...
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label for="send-welcome-email">
                      <?php echo lang( 'send_welcome_email' ); ?>
                      <i class="fas fa-info-circle text-sm" data-toggle="tooltip" data-placement="right" title="<?php echo lang( 'send_welcome_email_tip' ); ?>"></i>
                    </label>
                    <select id="send-welcome-email" class="form-control select2 search-disabled" name="u_send_welcome_email">
                      <option value="1" <?php echo select_single( 1, db_config( 'u_send_welcome_email' ) ); ?>><?php echo lang( 'yes' ); ?></option>
                      <option value="0" <?php echo select_single( 0, db_config( 'u_send_welcome_email' ) ); ?>><?php echo lang( 'no' ); ?></option>
                    </select>
                  </div>
                  <!-- /.form-group -->
                  <label for="default-user-role"><?php echo lang( 'default_user_role' ); ?></label>
                  <select id="default-user-role" class="form-control select2 search-disabled" name="u_default_user_role">
                    <?php if ( ! empty( $roles ) ) {
                      foreach ( $roles as $role ) {
                        $id = $role->id; ?>
                      <option value="<?php echo html_escape( $id ); ?>" <?php echo select_single( $id, db_config( 'u_default_user_role' ) ); ?>><?php echo html_escape( $role->name ); ?></option>
                    <?php }
                    } ?>
                  </select>
                </div>
                ...
                <div class="tab-pane" id="miscellaneous" role="tabpanel" aria-labelledby="miscellaneous-tab">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="allow-email-change"><?php echo lang( 'allow_email_change' ); ?></label>
                      <select id="allow-email-change" class="form-control select2 search-disabled" name="u_allow_email_change">
                        <option value="1" <?php echo select_single( 1, db_config( 'u_allow_email_change' ) ); ?>><?php echo lang( 'yes' ); ?></option>
                        <option value="0" <?php echo select_single( 0, db_config( 'u_allow_email_change' ) ); ?>><?php echo lang( 'no' ); ?></option>
                      </select>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group col-md-6">
                  ...
                  <!-- /.form-group -->
                  <label for="track-users-activities"><?php echo lang( 'track_users_activities' ); ?></label>
                  <select id="track-users-activities" class="form-control select2 search-disabled" name="u_track_activities">
                    <option value="1" <?php echo select_single( 1, db_config( 'u_track_activities' ) ); ?>><?php echo lang( 'yes' ); ?></option>
                    <option value="0" <?php echo select_single( 0, db_config( 'u_track_activities' ) ); ?>><?php echo lang( 'no' ); ?></option>
                  </select>
                </div>
                <!-- /.tab-pane -->
