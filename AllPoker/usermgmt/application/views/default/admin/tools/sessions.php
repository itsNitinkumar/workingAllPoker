                  ...
                  if ( ! empty( $sessions ) )
                  {
                    foreach ( $sessions as $session ) { ?>
                      <tr id="record-<?php echo html_escape( $session->id ); ?>">
                        ...
                        <td class="text-right">
                          <?php echo get_date_time_by_timezone( html_escape( $session->logged_in_at ) ); ?>
                          
                          <?php if ( $session->interface == 2 ) { ?>
                            <span class="badge badge-primary mt-2 d-block"><?php echo lang( 'api' ); ?></span>
                          <?php } ?>
                        </td>
                        <td class="text-right">
