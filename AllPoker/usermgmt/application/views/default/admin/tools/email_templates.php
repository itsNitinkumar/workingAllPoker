                  ...
                  if ( ! empty( $templates ) )
                  {
                    foreach ( $templates as $template ) {
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            <button class="btn btn-sm btn-info get-data-tool" data-source="<?php admin_action( 'tools/test_email_template' ); ?>" data-id="<?php echo html_escape( $id ); ?>">
                              <span class="fas fa-paper-plane get-data-tool-c"></span>
                            </button>
                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#edit-template-<?php echo html_escape( $id ); ?>">
...
<?php load_modals( ['admin/add_email_template', 'admin/emails', 'read', 'delete'] ); ?>