      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="card-title"><?php echo lang( 'tickets_categories' ); ?></h3>
            <div class="card-tools ml-auto">
              <button class="btn btn-success text-sm" data-toggle="modal" data-target="#add-tickets-category">
                <i class="fas fa-plus-circle mr-2"></i> <?php echo lang( 'add_tickets_category' ); ?>
              </button>
            </div>
            <!-- /.card-tools -->
          </div>
                  ...
                  if ( ! empty( $categories ) )
                  {
                    foreach ( $categories as $category ) {
                      ...
                      <tr id="record-<?php echo html_escape( $id ); ?>">
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            <button class="btn btn-sm btn-primary get-data-tool" data-source="<?php admin_action( 'support/edit_category' ); ?>" data-id="<?php echo html_escape( $id ); ?>">
...
<?php load_modals( ['admin/add_ticket_category', 'read', 'delete'] ); ?>