...
<td><?php echo html_escape( $price . ' ' . get_currency_code( $currency_id ) ); ?></td>
<td class="text-right"><?php echo html_escape( $days ); ?></td>
<td class="text-right"><?php echo html_escape( $sales ); ?></td>
<td class="text-right">
  <?php if ( $status == 0 ) { ?>
