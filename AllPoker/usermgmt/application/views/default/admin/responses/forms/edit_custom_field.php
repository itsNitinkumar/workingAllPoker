...
<form class="z-form" action="<?php admin_action( 'tools/update_custom_field' ); ?>" method="post">
  ...
  <div class="modal-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <select class="form-control select2 search-disabled" id="field-type-edit" name="type">
          ...
          <option value="password" <?php echo select_single( 'password', $type ); ?>><?php echo lang( 'password' ); ?></option>
    ...
    <!-- /.form-group -->
    <div class="form-group">
      <label for="show-when-register-edit"><?php echo lang( 'show_when_register' ); ?></label>
      <select class="form-control select2 search-disabled" id="show-when-register-edit" name="on_registeration">
        <option value="1" <?php echo select_single( 1, $on_registeration ); ?>><?php echo lang( 'yes' ); ?></option>
        <option value="0" <?php echo select_single( 0, $on_registeration ); ?>><?php echo lang( 'no' ); ?></option>
      </select>
    </div>
    <!-- /.form-group -->
