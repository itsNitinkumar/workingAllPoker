            ...
            <div class="card-tools ml-auto">
              <form action="<?php echo env_url( 'admin/users/manage' ); ?>" class="d-inline-block form-inline mr-2">
                ...
                <select class="form-control text-sm search-users-field mr-1 mb-2 mb-sm-0" name="filter">
                  ...
                  <option value="premium_time" <?php echo select_user_filter( 'premium_time' ); ?>><?php echo lang( 'having_premium_time' ); ?></option>
                      ...
                      <tr id="record-<?php echo html_escape( $id ); ?>">
                        ...
                        <td>
                          <div class="d-inline-block align-middle position-relative mr-2">
                            ...
                            <?php if ( $user->premium_time == -1 || $user->premium_time > time() ) { ?>
                              <img
                                class="position-absolute premium-badge"
                                src="<?php assets_path( 'icons/premium_badge.png' ); ?>"
                                data-toggle="tooltip"
                                data-placement="right"
                                title="<?php echo lang( 'having_premium_time' ); ?>"
                                alt="">
                            <?php } ?>
                          </div>
                        ...
                        <td>
                          ...
                          <div class="text-muted">
                            ...
                            <?php } else if ( $user->registration_source == 5 ) { ?>
                              <small>
                                <i class="fab fa-vk"></i>
                                <?php echo lang( 'reg_with_vkontakte' ); ?>
                              </small>
                            <?php } ?>
                          </div>
                        ...
                        <td class="text-right">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <?php if ( $this->zuser->has_permission( 'payment' ) ) { ?>
                              <a class="dropdown-item" href="<?php echo env_url( "admin/users/adjust_balance/{$id}" ); ?>">
