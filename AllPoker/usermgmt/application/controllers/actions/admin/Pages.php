...
class Pages extends MY_Controller {
    ...
    {
        if ( $this->form_validation->run( 'built_in_page' ) )
        {
            $id = intval( post( 'id' ) );
            ...
            {
                log_user_activity( 'page_updated', $id );
    ...
    public function create_custom_page()
    {
        if ( $this->form_validation->run( 'page' ) )
        {
            ...
            if ( ! empty( $id ) )
            {
                log_user_activity( 'custom_page_created', $id );
    ...
    public function update_custom_page()
    {
        if ( $this->form_validation->run( 'page' ) )
        {
            ...
            {
                log_user_activity( 'custom_page_updated', $id );
    ...
    public function delete_custom_page()
    {
        ...
        if ( ! empty( $data ) )
        {
            ...
            {
                log_user_activity( 'custom_page_deleted', $id );
